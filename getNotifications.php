<?php
	...
	for($i = 0; $i < $num_rows; $i++) {
		...
		array_push($notifications, array("sender_id" => $row["user_id1"], "receiver_id" => $row['user_id2'], "sender_username" => $username, "sender_image_url" => $row['sender_image_url']));
	}
